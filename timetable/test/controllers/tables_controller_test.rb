...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { day: @table.day, limit: @table.limit, professor: @table.professor, room: @table.room, subject: @table.subject, unit: @table.unit } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { day: @table.day, limit: @table.limit, professor: @table.professor, room: @table.room, subject: @table.subject, unit: @table.unit } }
